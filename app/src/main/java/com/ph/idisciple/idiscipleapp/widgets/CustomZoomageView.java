package com.ph.idisciple.idiscipleapp.widgets;
 ...
 * visible window.
 * From:  com.jsibbold.zoomage
 */
public class CustomZoomageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    public CustomZoomageView(Context context) {
        super(context);
        init(context, null);
    }

    public CustomZoomageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomZoomageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        doubleTapToZoom = values.getBoolean(com.jsibbold.zoomage.R.styleable.ZoomageView_zoomage_doubleTapToZoom, true);
        ...
        doubleTapToZoomScaleFactor = values.getFloat(com.jsibbold.zoomage.R.styleable.ZoomageView_zoomage_doubleTapToZoomScaleFactor, 3);
